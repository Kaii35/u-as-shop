...
/** Dos columnas en desktop (formulario + editorial); en móvil sólo el formulario. */
export function AuthLayout({ children, image, aside, reverse }: { children: ReactNode; image?: string; aside: ReactNode; reverse?: boolean }) {
  return (
    <div className={cn('flex min-h-[calc(100vh-150px)]', reverse && 'flex-row-reverse')}>
